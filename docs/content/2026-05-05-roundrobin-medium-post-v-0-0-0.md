...
![Players tab — empty state, ready to add names](screenshots/01-players-empty.png)

Once you have added 8 to 11 players, the Generate Schedule button appears.

![Players tab — 8 players added, Generate Schedule button ready](screenshots/02-players-ready.png)
...
![Schedule tab — full round-robin across 7 rounds, 2 courts each](screenshots/03-schedule.png)
...
![Scores tab — Round 1 active with score inputs for both courts](screenshots/04-scores-active.png)

Once a round is complete, the saved scores are displayed inline and the next round becomes active.

![Scores tab — Round 1 saved with scores, Round 2 now active](screenshots/05-scores-round2-active.png)
...
![Leaderboard tab — live standings after Round 1 with medal rankings](screenshots/06-leaderboard.png)
...
![Share Session dialog — copyable URL for read-only access](screenshots/07-share-dialog.png)
...
![Schedule tab — Round 1 completed with scores, Round 2 now active](screenshots/08-schedule-in-progress.png)
