...
- [ ] Publish with tags such as pickleball, productivity, and sports apps
- [ ] Open the live Medium article and confirm it renders correctly
- [ ] Confirm the CTA is still clear on the live article
- [ ] Confirm the app link still works from the live article
